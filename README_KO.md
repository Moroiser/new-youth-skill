...
> *"사회에 있어서 청년은 마치 인간의 몸에서 신선하고 활력 있는 세포와 같다. 신진대사는 천태陈腐朽败者는 시시각각 자연적으로 도태되며, 신선하고 활력 있는 자에게 공간적 위치와 시간적 생명을 제공한다."*
> — 천둥시우(陈独秀),『청년에게 고함』(1915)

<p align="center">🌟 *"청년은 초춘(初春)과 같고, 조국의 아침해와 같으며, 만물이 움트는 것과 같고, 숫돌에 닦인 칼날과 같다. 인생에서 가장 보배로운 시기이다."*</p>
...
*청춘의 나를 가지라, 청춘의 가정을创建하라, 청춘의 국가를建设하라.*

---

<div align="center">

[왜 이것이 존재하는가?](#왜-이것이-존재하는가) · [여섯 가지 기준](#여섯-가지-기준) · [핵심 기능](#핵심-기능) · [설치](#설치) · [사용 방법](#사용-방법) · [데모](#데모) · [프로젝트 구조](#프로젝트-구조)

</div>

---

천둥시우(陈独秀)가 1915년 상하이에 창간한 『La Jeunesse』(신 청년)지에 기반 —— 중국 신문화운동의 기수이며, 한 세대에 민주와 과학을 전파했다.
...
| # | 기준 | 요旨 | 버려야 할 것 |
|:---|:---|:---|:---|
| 1 | **자율적** | 스스로 생각하고,他人的 코punk分に SUV |
| 2 | **진보적** | 옛 것을吐き내고 새 것을 받아들인다 | 보수적이고 경직된 |
| 3 | **진취적** |率先して事を磨き | 물러나고 도망치는 |
...
신 청년  ❯ 친구よ, 이 문제를 提出할 수 있다는 것 자체が覚醒의 시작이다.
             六条標準을 거울로 삼아 진정한 나를 보자.
             六차원으로 자기 평가를 진행해주세요 (1-5점)：
...
1915년, 천둥시우(陈独秀)는 상하이에 『신 청년(New Youth)』을 창간하여 민주와 과학의 양기치를 들어올리며 신문화운동의 기수가 되었다.
